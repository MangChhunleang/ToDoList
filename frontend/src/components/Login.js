    ...
    <div className="max-w-md mx-auto mt-16 bg-white dark:bg-gray-900 rounded-xl shadow-lg p-8 border dark:border-gray-700">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div className="relative">
          ...
          <input
            type="email"
            className="pl-10 pr-4 py-2 w-full border border-slate-300 rounded-lg focus:border-blue-600 focus:ring-2 focus:ring-blue-200 bg-white dark:bg-gray-900 dark:border-gray-700 dark:text-slate-100"
            placeholder="Email"
            value={email}
        ...
        <button
          type="submit"
          className="w-full flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white py-2 rounded-lg font-semibold shadow transition dark:bg-blue-300 dark:hover:bg-blue-400 dark:text-slate-900"
          disabled={loading}
        >
          {loading ? (
